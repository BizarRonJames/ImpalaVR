...
public class FreeFlyCamera : MonoBehaviour
{
    ...
    private void Awake()
    {
        if (shouldInstance)
        {
            ...
            {
                //Debug.LogError("There is more than one instance of FreeFlyCam in this scene");
                Destroy(this);
            }
        }
    ...
    public Vector3 startPosition = new Vector3(-61, 8, 14);
    public Vector3 startRotation = new Vector3(6, -121, 0);
    ...
    public void TurnOffCamera(Transform newParent)
    {
        _active = false;
    ...
    [ContextMenu("Free Fly")]
    public void TurnOnFreeFly()
    {
        _active = true;
