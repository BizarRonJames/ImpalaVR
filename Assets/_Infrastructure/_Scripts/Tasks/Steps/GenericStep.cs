...
public class GenericStep : TutorialStep
{
    ...
    {
        if (value != "" && Information.instance!=null)
        {
            stateValues = value.ToCharArray();
           // Information.instance.ShowInfo(headerText, subHeaderText, InstructionMessage);
        }
        //network values 
    ...
    protected override void ShowStatus()
    {
        ...
        if (stateValues[0] == '0')
            Information.instance.ShowInstructions(headerText, subHeaderText, InstructionMessage);
