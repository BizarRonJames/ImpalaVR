...
public partial class NetworkedPlayerModel
{
    ...
    [RealtimeProperty(15, true, true)] bool _headlampSwitch;
...
public partial class NetworkedPlayerModel : RealtimeModel {
    ...
    public bool headlampSwitch {
        get {
            return _headlampSwitchProperty.value;
        }
        set {
            if (_headlampSwitchProperty.value == value) return;
            _headlampSwitchProperty.value = value;
            InvalidateReliableLength();
            FireHeadlampSwitchDidChange(value);
        }
    }
    ...
    public event PropertyChangedHandler<bool> headlampSwitchDidChange;
    ...
    private ReliableProperty<bool> _headlampSwitchProperty;
    ...
    public NetworkedPlayerModel() : base(null) {
        ...
        _headlampSwitchProperty = new ReliableProperty<bool>(15, _headlampSwitch);
    }
    ...
    protected override void OnParentReplaced(RealtimeModel previousParent, RealtimeModel currentParent) {
        ...
        _headlampSwitchProperty.UnsubscribeCallback();
    }
    ...
    private void FireHeadlampSwitchDidChange(bool value) {
        try {
            headlampSwitchDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        length += _headlampSwitchProperty.WriteLength(context);
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        writes |= _headlampSwitchProperty.Write(stream, context);
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            ...
            switch (propertyID) {
                ...
                case (uint) PropertyID.HeadlampSwitch: {
                    changed = _headlampSwitchProperty.Read(stream, context);
                    if (changed) FireHeadlampSwitchDidChange(headlampSwitch);
                    break;
                }
                default: {
                    stream.SkipProperty();
    ...
    private void UpdateBackingFields() {
        ...
        _ppe = ppe;
        _headlampSwitch = headlampSwitch;
    }
